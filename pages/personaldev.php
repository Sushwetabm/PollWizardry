...
<head>
  ...
  <title>Personal Development Initiatives Survey</title>
  <style>
    body {
...
<form action="personaldev_submit.php" method="post">
  <h1>Personal Development Initiatives</h1>
  <table>
    <thead>
      <tr>
