...
<head>
  ...
  <title>Views on Climate Change and Conservation Survey</title>
  <style>
    body {
...
<form action="viewsonclimate_submit.php" method="post">
  <h1>Views on Climate Change and Conservation</h1>
  <table>
    <thead>
      <tr>
